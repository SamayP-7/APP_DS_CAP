...
option_list = [{'label': i, 'value': i} for i in list(spacex_df['Launch Site'].unique())]
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        count_df = filtered_df.groupby('class')['class'].count().to_frame().rename(columns= {'class': 'count'}).reset_index()
